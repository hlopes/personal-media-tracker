...
-- Rating must be present when COMPLETED, absent when watchlist; other statuses allow nullable rating
...
ALTER TABLE library_entries ADD CONSTRAINT chk_library_entries_rating_watchlist CHECK (status <> 'watchlist' OR rating IS NULL);

...
public class CatalogResourceTest {
    ...
    public void testSearchValidationQMissing() {
        ...
        // Test validation via direct service would be 400, but via API auth takes
        // precedence
        // So we test that unauth takes precedence, and with mocked auth, q validation
        // would be 400
    ...
    public void testSearchWithMockedTmdb() {
        // Full 200 flow with verified user + mocked TMDB is covered via integration
        // test
        // This placeholder ensures the seam compiles; actual 200 is tested when Docker
        // is available
    }
